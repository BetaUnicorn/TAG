...
public class Setup {
    ...
    public ArrayList<Room> createRooms() {
        ...
        rooms.add(new Room("room4", "DESCRIPTIIIIOOOONN", "FEEEEELING"));
        rooms.add(new Room("room5", "DESCRIPTIIIIOOOONN", "FEEEEELING"));
        rooms.add(new Room("room6", "DESCRIPTIIIIOOOONN", "FEEEEELING"));
        rooms.add(new Room("room7", "DESCRIPTIIIIOOOONN", "FEEEEELING"));
        rooms.add(new Room("room8", "DESCRIPTIIIIOOOONN", "FEEEEELING"));
        rooms.add(new Room("room9", "DESCRIPTIIIIOOOONN", "FEEEEELING"));
        rooms.add(new Room("room10", "DESCRIPTIIIIOOOONN", "FEEEEELING"));
        rooms.add(new Room("FinalRoom", "DESCRIPTIIIIOOOONN", "FEEEEELING"));
